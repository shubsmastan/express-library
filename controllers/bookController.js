...
const BookInstance = require("../models/bookinstance_");
...
exports.book_create_post = [
  ...
  body("title", "Please enter a book title.")
    .trim()
    .isLength({ min: 1 })
    .escape(),
  body("author", "Please select an author.")
    .trim()
    .isLength({ min: 1 })
    .escape(),
  body("summary", "Please enter a short summary of the book.")
    .trim()
    .isLength({ min: 1 })
    .escape(),
